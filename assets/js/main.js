    ...
    priceRangeWidgets.forEach(widget => {
      ...
      if (applyButton) {
        applyButton.addEventListener('click', function() {
          ...
          console.log(`Applying price filter: ${minValue} Points - ${maxValue} Points`);
      ...
      function updateDisplays() {
        minPriceDisplay.textContent = `${minValue} Points`;
        maxPriceDisplay.textContent = `${maxValue} Points`;
      }
    });
  }
  priceRangeWidget();
